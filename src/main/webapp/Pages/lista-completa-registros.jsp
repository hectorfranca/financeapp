...
<html lang="pt-br">
    <head>
        ...
        <title>FinanceApp - Registros Completos</title>
    ...
    <body>
        ...
        <div class="container-primario">     
            <form id="voltar-form" action="${pageContext.request.contextPath}/FiltrarRegistros" method="POST">
            ...
            <form id="editar-registro-form" action="${pageContext.request.contextPath}/CadastrarRegistro" method="POST">
            ...
            <form id="excluir-registro-form" action="${pageContext.request.contextPath}/ExcluirRegistro" method="POST">
