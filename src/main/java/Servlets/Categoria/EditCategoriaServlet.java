...
public class EditCategoriaServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {            
            requestDispatcher = request.getRequestDispatcher("editarCategoria.jsp");
            ...
            throw new jakarta.servlet.ServletException("Não foi possível passar os dados da categoria: " 
