...
@WebServlet(name = "ListarRegistros", urlPatterns = {"/ListarRegistros"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {            
            ...
            if (request.getParameter("tipoLista").equals("completa")) {
                ...
                requestDispatcher = request.getRequestDispatcher("/Pages/lista-completa-registros.jsp");
                ...
                requestDispatcher = request.getRequestDispatcher("/Pages/lista-resumida-registros.jsp");
