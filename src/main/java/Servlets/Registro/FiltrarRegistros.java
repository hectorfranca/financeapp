...
@WebServlet(name = "FiltrarRegistros", urlPatterns = {"/FiltrarRegistros"})
public class FiltrarRegistros extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {            
            if (!request.getParameter("tipo").equals("R") 
                ...
                requestDispatcher = request.getRequestDispatcher("/Pages/filtro-registros.jsp");
